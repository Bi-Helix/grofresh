            ...
            <div class="form-payment">
                <div class="products">
                    ...
                    <div class="total">{{translate('amount_to_be_paid')}}<span
                            class="price">{{ $data['order_amount'] }}</span></div>
                </div>
                <div class="payment-details">
                    <form id="form-checkout">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <br>
                                <button id="form-checkout__submit" type="submit" class="btn btn-primary btn-block">Pay
                                </button>
                                <br>
...
<script>
    ...
    function loadCardForm() {
        const productCost = '{{$data['order_amount']}}';
