...
<head>
    ...
    <title>{{ translate('Deliveryman Delete') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <h2>{{ translate('Your Account Has Been Deleted By Admin !') }}</h2>
            <div class="mb-1">{{ translate('Hi') }} {{ $dm->name?? '' }},</div>
            <div
                class="mb-2">{{ translate('Admin has deleted your account. you cannot login to app and cannot operate any action in the app from now') }}</div>
            <img class="mb-2" src="{{asset('/public/assets/admin/img/email-templates/delete.png')}}" alt="img">
            <hr>
            <div class="mb-2">
