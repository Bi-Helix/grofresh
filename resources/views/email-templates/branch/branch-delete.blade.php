...
<head>
    ...
    <title>{{ translate('Branch Delete') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <h2>{{ translate('Your Branch Has Been Deleted By Admin') }}</h2>
            <div class="mb-1">{{ translate('Hi') }} {{ $branch->name?? '' }},</div>
            <div
                class="mb-2">{{ translate('Admin has deleted your account. you cannot login to branch panel and cannot operate any action from now') }}</div>
