...
<head>
    ...
    <title>{{ translate('Branch Login Alert') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <h2>{{ translate('Branch Login Alert !') }}</h2>
            <div class="mb-1">{{ translate('Hi ') }} {{ $name }}</div>
            <div class="mb-4">{{ translate('Your account has been been login from a new IP') }}
                <strong>{{ $ip_address }}</strong></div>
            <hr>
            <div class="mb-2">
