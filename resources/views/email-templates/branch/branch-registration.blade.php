...
<head>
    ...
    <title>{{ translate('Branch Registrations') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <h2>{{ translate('Registration Complete !') }}</h2>
            <div class="mb-1">{{ translate('Hi') }} {{ $branch->name?? '' }},</div>
            <div
                class="mb-2">{{ translate('Admin has created your branch. Your branch panel credential is given below') }}</div>
            <div class="">{{ translate('Email') }}: {{ $branch->email??'' }}</div>
            <div class="mb-2">{{ translate('Password') }}: {{ $password ??''}}</div>
            <div class="mb-2" style="color: #E45353">*{{ translate('Please Change the password after login') }}</div>
            <img class="mb-2" src="{{asset('/public/assets/admin/img/email-templates/branch-reg.png')}}" alt="img">
            <div class="mb-3">{{ translate('Click on the button below to login') }}</div>
            <a href="{{ route('branch.auth.login') }}" class="cmn-btn">{{ translate('Visit Your Branch Panel') }}</a>
            <hr>
            <div class="mb-2">
