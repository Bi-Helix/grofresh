...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <div class="mb-4">
                <strong>{{ $name }}</strong> {{ translate('has requested to join as delivery man in') }} {{ $business_name }}
            </div>
            ...
            <a href="{{ route('admin.delivery-man.pending') }}"
               class="cmn-btn">{{ translate('See Registration Request') }}</a>
            <hr>
            <div class="mb-2">
