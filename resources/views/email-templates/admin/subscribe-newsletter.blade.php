...
<head>
    ...
    <title>{{ translate('New Subscribe Newsletter') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            <div class="mb-4">
                <strong>{{ $name ?? ''}}</strong> {{ translate('has just subscribed to '. $business_name .' newsletter') }}
            </div>
            <img class="mb-2" src="{{asset('/public/assets/admin/img/email-templates/subscribe-newsletter.png')}}"
                 alt="png">
            <div class="mb-3">{{ translate('Click on the button below to review your subscribers') }}</div>
            <a href="{{ route('admin.customer.subscribed_emails') }}"
               class="cmn-btn">{{ translate('View Subscribers') }}</a>
            <hr>
            <div class="mb-2">
