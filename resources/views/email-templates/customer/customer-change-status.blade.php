...
<head>
    ...
    <title>{{ translate('Customer Status Change') }}</title>
...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            ...
            @if($user->is_block == 0)
                <h2>{{ translate('Your Account Has Been Reopened By Admin !') }}</h2>
                <div class="mb-1">{{ translate('Hi') }} {{ $user->f_name. ' '. $user->l_name }},</div>
                <div
                    class="mb-2">{{ translate('Admin has reopened your account. you cannot login to app and can operate any action in the app') }}</div>
                <img class="mb-2" src="{{asset('/public/assets/admin/img/email-templates/status-on.png')}}" alt="img">
            @endif
            @if($user->is_block == 1)
                <h2>{{ translate('Your Account Has Been Suspended By Admin !') }}</h2>
                <div class="mb-1">{{ translate('Hi') }} {{ $user->f_name. ' '. $user->l_name }},</div>
                <div
                    class="mb-2">{{ translate('Admin has suspended your account. you cannot login to app and cannot operate any action in the app') }}</div>
