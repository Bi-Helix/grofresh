...
<table class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            <h2 class="mb-3">{{ translate('Your Order ') }}
                #{{ $order->id }} {{ translate(' has been placed successfully') }}!</h2>
            <div
                class="mb-1">{{ translate('Hi ') }} {{ $order->customer ? $order->customer->f_name. ' '. $order->customer->l_name: '' }}
                ,
            </div>
            <div class="mb-4">{{ translate('Your order from') }} <a href=""
                                                                    class="text-base font-medium">{{ $business_name }}</a> {{ translate(' has been placed') }}
            </div>
                ...
                <tr>
                    <td class="p-10">
                                <span class="d-block text-center">
                                    <img style="width: 125px" class="mb-"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <table class="w-100">
                                                ...
                                                <tr>
                                                    <td style="width: 40%"></td>
                                                    <td class="p-1 px-3">{{translate('Tax / VAT')}} {{ $vat_status == 'included' ? translate('(included)') : '' }}
                                                        :
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right p-1 px-3">
                                                        <span
                                                            class="text-base">{{ Helpers::set_symbol($sub_total+$del_c+$updated_total_tax-$order['coupon_discount_amount']-$order['extra_discount'] - $total_product_discount) }}</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
