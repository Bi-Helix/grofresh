                    ...
                    @if(is_array($cartItem))
                        ...
                        <tr>
                            ...
                            <td class="align-items-center text-center">
                                <input type="number" data-key="{{$key}}" class="amount--input form-control text-center"
                                       id="{{ $cartItem['id'] }}"
                            ...
                            <td class="align-items-center text-center">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <a href="javascript:removeFromCart({{$key}})"
                                       class="btn btn-sm btn--danger rounded-full action-btn"> <i
                ...
                <form action="{{route('branch.pos.discount')}}" method="post" class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" min="0" max="" value="{{session()->get('cart')['extra_discount'] ?? 0}}"
                               class="form-control" id="extra_discount_input" name="discount" step="any"
