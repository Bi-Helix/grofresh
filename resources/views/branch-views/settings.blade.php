...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{env('APP_MODE')!='demo'?route('branch.settings'):'javascript:'}}" method="post"
                      enctype="multipart/form-data" id="branch-settings-form">
                    @csrf
                    <!-- Card -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                       class="col-sm-3 col-form-label input-label">{{ translate('Branch name') }} <i
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                        onclick="{{env('APP_MODE')!='demo'?"form_alert('branch-settings-form','".translate("Want to update branch info ?")."')":"call_demo()"}}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title"><i
                                class="tio-user-outlined nav-icon"></i> {{ translate('Change password') }}</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form id="changePasswordForm"
                              action="{{env('APP_MODE')!='demo'?route('branch.settings-password'):'javascript:'}}"
                              method="post"
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                        onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','".translate("Want to update branch password ?")."')":"call_demo()"}}"
                                        class="btn btn-primary">{{ translate('Save Changes') }}</button>
                            </div>
                        </form>
                        <!-- End Form -->
