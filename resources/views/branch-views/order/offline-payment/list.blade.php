    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <ul class="nav nav-tabs border-0 my-2">
                <li class="nav-item">
                    <a class="nav-link {{Request::is('branch/verify-offline-payment/pending')?'active':''}}"
                       href="{{route('branch.verify-offline-payment', ['pending'])}}">{{ translate('Pending Orders') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{Request::is('branch/verify-offline-payment/denied')?'active':''}}"
                       href="{{route('branch.verify-offline-payment', ['denied'])}}">{{ translate('Denied Orders') }}</a>
                </li>
            </ul>
        </div>
        <!-- Page Header End -->
