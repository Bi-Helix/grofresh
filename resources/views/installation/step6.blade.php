    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <div class="text-center">
                <a href="{{ env('APP_URL') }}/admin/auth/login" target="_blank" class="btn btn-dark px-sm-5">Admin
                    Panel</a>
                <a href="{{ env('APP_URL') }}/branch/auth/login" target="_blank" class="btn btn-dark px-sm-5">Branch
                    Panel</a>
            </div>
        </div>
    </div>
