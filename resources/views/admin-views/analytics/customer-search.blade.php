                        ...
                        <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                            ...
                            <div class="select-wrap d-flex flex-wrap gap-10">
                                <select class="form-control js-select2-custom min-w180 h-30 top-customers__select">
                                    <option
                                        value="today" {{array_key_exists('date_range', $query_params) && $query_params['date_range']=='today'?'selected':''}}>{{translate('Today')}}</option>
                                    <option
                                        value="all_time" {{array_key_exists('date_range', $query_params) && $query_params['date_range']=='all_time'?'selected':''}}>{{translate('All_Time')}}</option>
                                    <option
                        ...
                        <div class="d-flex flex-wrap justify-content-between gap-3">
                            ...
                            <div class="select-wrap d-flex flex-wrap gap-10">
                                <select class="form-control js-select2-custom min-w180 h-30 top-services__select">
                                    <option
                                        value="today" {{array_key_exists('date_range_2', $query_params) && $query_params['date_range_2']=='today'?'selected':''}}>{{translate('Today')}}</option>
                                    <option
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li>
                            <a class="dropdown-item"
                               href="{{ route('admin.analytics.customer.export.excel') }}">{{translate('Excel')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="card-body pt-0">
                            <div>
                                ...
                                <p><strong>{{ translate('Related Categories') }}
                                        :</strong> {{ $customer->related_category_count }}</p>
                                <ul>
                                        <?php
                                ...
                                <p><strong>{{ translate('Related Products') }}
                                        :</strong> {{ $customer->related_product_count }}</p>
                            </div>
