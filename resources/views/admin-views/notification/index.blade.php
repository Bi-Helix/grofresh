                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea name="description" class="form-control h--92px"
                                                  placeholder="{{ translate('Ex : Max 250 Words') }}"
                ...
                <div class="card">
                    <div class="card-header border-0 flex-between">
                        <div class="card--header">
                            <h5 class="card-title">{{translate('Notifications Table')}} <span
                                    class="ml-2 badge badge-pill badge-soft-secondary">{{ $notifications->total() }}</span>
                            </h5>
