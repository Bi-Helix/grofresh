...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{route('admin.offer.flash.update', [$flash_deal['id']])}}" method="post"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="date" name="start_date"
                                               value="{{date('Y-m-d',strtotime($flash_deal['start_date']))}}" required
                                               id="start_date"
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="date" name="end_date"
                                               value="{{date('Y-m-d', strtotime($flash_deal['end_date']))}}" required
                                               id="end_date"
                                               class="js-flatpickr form-control flatpickr-custom"
                                               placeholder="{{ \App\CentralLogics\translate('dd/mm/yy') }}"
                                               data-hs-flatpickr-options='{ "dateFormat": "Y/m/d", "minDate": "today" }'>
