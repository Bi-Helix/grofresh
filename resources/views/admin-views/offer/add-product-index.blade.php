                        ...
                        <form action="{{route('admin.offer.flash.add-product',[$flash_deal['id']])}}" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="name"
                                               class="title-color text-capitalize">{{ translate('Add new product')}}</label>
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control h--45px"
                                            name="product_id">
                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <h5 class="mb-0 text-capitalize">
                            ...
                            <span
                                class="badge badge-soft-dark radius-50 fz-12 ml-1">{{ $flash_deal_products->total() }}</span>
                        </h5>
                    </div>
                        ...
                        <table
                            ...
                            @foreach($flash_deal_products as $k=>$de_p)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.product.view', [$de_p['id']]) }}" target="_blank"
                                           class="font-weight-semibold title-color hover-c1">{{$de_p['name']}}</a></td>
