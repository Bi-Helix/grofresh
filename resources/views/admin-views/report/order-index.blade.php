                ...
                <form action="{{route('admin.report.set-date')}}" method="post">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div>
                                <label
                                    class="form-label mb-0 font-semibold">{{translate('show')}} {{translate('data')}} {{translate('by')}} {{translate('date')}}
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <label class="input-date">
                                <input type="text" name="from" id="from_date"
                                       class="js-flatpickr form-control flatpickr-custom flatpickr-input"
                                       placeholder="{{ session('from_date') }}" required>
                            </label>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            ...
                            <label class="input-date">
                                <input type="text" name="to" id="to_date"
                                       class="js-flatpickr form-control flatpickr-custom flatpickr-input"
                                       placeholder="{{ session('to_date') }}" required>
                            </label>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div>
                                <button type="submit"
                                        class="btn btn--primary min-h-45px btn-block">{{translate('show')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
