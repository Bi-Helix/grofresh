                        ...
                        <form class="w-100">
                            <div class="row g-3 g-sm-4 g-md-3 g-lg-4">
                                <div class="col-sm-6 col-md-4 col-lg-2">
                                    <div class="input-date-group">
                                        <select class="form-control __form-control" name="date_type" id="date_type">
                                            ...
                                            <option
                                                value="this_year" {{ $date_type == 'this_year'? 'selected' : '' }}>{{translate('This Year')}}</option>
                                            <option
                                                value="this_month" {{ $date_type == 'this_month'? 'selected' : '' }}>{{translate('This Month')}}</option>
                                            <option
                                                value="this_week" {{ $date_type == 'this_week'? 'selected' : '' }}>{{translate('This Week')}}</option>
                                            <option
                                                value="custom_date" {{ $date_type == 'custom_date'? 'selected' : '' }}>{{translate('Custom Date')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-lg-3" id="start_date_div">
                                    <div class="input-date-group">
                                        <label class="input-label"
                                               for="start_date">{{ translate('Start Date') }}</label>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4 __btn-row">
                                    <a href="{{route('admin.report.expense')}}" id=""
                ...
                <div class="px-3 py-4">
                    <div class="d-flex flex-wrap gap-3 align-items-center">
                        <h4 class="mb-0 mr-auto">
                            ...
                            <span
                                class="badge badge-soft-dark radius-50 fz-12">{{ $expense_transactions_table->total() }}</span>
                        </h4>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item"
                                       href="{{ route('admin.report.expense.export.excel', ['search'=>request('search'), 'date_type'=>request('date_type'), 'start_date'=>request('start_date'), 'end_date'=>request('end_date')]) }}">{{translate('Excel')}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
@push('script_2')
    ...
    <script
        src="{{ asset('public/assets/admin') }}/js/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
