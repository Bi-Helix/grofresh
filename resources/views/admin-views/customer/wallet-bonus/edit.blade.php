                                ...
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                               value="{{ $bonus['title'] }}" maxlength="255"
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="bonus_type" class="form-control" id="bonus_type" required>
                                            <option
                                                value="amount" {{$bonus['bonus_type']=='amount'?'selected':''}}>{{translate('amount')}}</option>
                                            <option
                                                value="percentage" {{$bonus['bonus_type']=='percentage'?'selected':''}}>{{translate('percentage')}}
                                                (%)
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99"
                                               ...
                                               id="bonus_amount" value="{{$bonus['bonus_amount']}}" class="form-control"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99"
                                               ...
                                               id="minimum_add_amount" value="{{$bonus['minimum_add_amount']}}"
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6" id="maximum_bonus_amount_div">
                                    <div class="form-group m-0">
                                        ...
                                        <input type="number" min="0" max="999999999999.99" step="0.01"
                                               value="{{$bonus['maximum_bonus_amount']}}" name="maximum_bonus_amount"
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="start_date" class="form-control"
                                               value="{{date('Y-m-d',strtotime($bonus['start_date']))}}" id="date_from"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="end_date" class="form-control"
                                               value="{{date('Y-m-d',strtotime($bonus['end_date']))}}" id="date_to"
                                               required>
                                    </div>
                                </div>
                            </div>
