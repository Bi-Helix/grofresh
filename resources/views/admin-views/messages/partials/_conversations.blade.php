    ...
    <div class="card-body p-0">
                            ...
                            @if($con->image != null && $con->image != "null" && count(json_decode($con->image, true)) > 0)
                                ...
                                <div class="__gap-2">
                                    @foreach($image_array as $key=>$image)
                                        @php($image_url = $image)
                                        <div>
                                            <a href="{{asset('storage/app/public/conversation')}}/{{$image}}"
                                               data-lightbox>
                                                <img class="__img-120"
                                                     src="{{asset('storage/app/public/conversation')}}/{{$image}}"/></a>
                                        </div>
                                    @endforeach
                                </div>
                            @endif
        ...
        <form action="javascript:" method="post" class="mx-3 pb-3 position-relative" id="reply-form">
            ...
            <div id="accordion" class="d-flex justify-content-end conv-buttons">
                <button class="btn btn-primary mr-2 collapsed" data-toggle="collapse" data-target="#collapseTwo"
