    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('Messages')}} <span class="badge badge-soft-primary ml-2"
                                                    id="conversation_count"></span>
                </span>
            </h1>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row g-0">
                                    ...
                                    @if(isset($user))
                                        ...
                                        <div
                                            ...
                                            <div class="conv-open-user w-100">
                                                ...
                                                <span class="{{$unchecked!=0?'badge badge-info':'badge badge-info'}}"
            ...
            <div class="col-md-8 col-xxl-9 pl-0 view-conversion" id="view-conversation">
                <center
                    class="h-100 d-flex justify-content-center align-items-center card __shadow rounded-left-0 py-5 py-md-0">
