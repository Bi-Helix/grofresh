                                ...
                                <div class="col-md-6">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                       for="">{{\App\CentralLogics\translate('address')}}</label>
                                                {{--<input type="text" name="address" value="{{$branch['address']}}" class="form-control" placeholder="" required>--}}
                                                <textarea type="text" name="address" class="form-control h--90px"
                            ...
                            <div class="row g-3 mt-3">
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="phone" name="phone" value="{{$branch['phone']}}"
                                               class="form-control"
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CentralLogics\translate('password')}}
                                            <span class="" style="color: red;font-size: small">* ( {{ translate('input if you want to reset.') }} )</span></label>
                                    ...
                                    <div class="row  g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="coverage" min="1"
                                                       value="{{$branch['coverage']}}" max="1000" class="form-control"
