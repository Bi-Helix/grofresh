            ...
            <div class="card-header border-0">
                <div class="card--header">
                    ...
                    <div class="hs-unfold ml-sm-auto">
                        <a class="js-hs-unfold-invoker btn btn-sm btn-white dropdown-toggle btn export-btn btn-outline-primary-2 btn--primary font--sm"
                           href="javascript:;"
            ...
            <div class="card-body px-0 pt-0">
                <div class="table-responsive">
                    <table id="datatable"
                           ...
                           class="table table-borderless table-hover table-align-middle m-0 text-14px">
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <a class="action-btn btn--danger btn-outline-danger" href="javascript:"
                                               onclick="form_alert('employee-{{$e['id']}}','{{translate('Want to delete this employee ?')}}')"><i
                                                    class="tio-delete-outlined"></i></a>
                                            <form action="{{route('admin.employee.delete',[$e['id']])}}" method="post"
                                                  id="employee-{{$e['id']}}">
                                                @csrf @method('delete')
                                            </form>
                                        </div>
