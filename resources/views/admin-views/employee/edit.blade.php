                        ...
                        <div class="col-md-6">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name" value="{{$e['f_name'] . ' ' . $e['l_name']}}"
                                           class="form-control" id="name"
                                           placeholder="{{translate('Ex')}} : {{translate('Md. Al Imrun')}}">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">{{translate('Phone')}}</label>
                                    <input type="text" value="{{$e['phone']}}" required name="phone"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="identity_type" class="form-control">
                                        <option
                                            value="passport" {{$e['identity_type'] == 'passport' ? 'selected' : ''}}>{{translate('passport')}}</option>
                                        <option
                                            value="driving_license" {{$e['identity_type'] == 'driving_license' ? 'selected' : ''}}>{{translate('driving')}} {{translate('license')}}</option>
                                        <option
                                            value="nid" {{$e['identity_type'] == 'nid' ? 'selected' : ''}}>{{translate('nid')}}</option>
                                    </select>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="identity_number"
                                           ...
                                           placeholder="{{translate('Identity Number')}} : 674-5596-9854" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <label class="form-label">{{translate('Password')}}</label><small
                                class="text-danger">( {{translate('input if you want to change')}} )</small>
