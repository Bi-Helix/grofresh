        ...
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                <img onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                     ...
                     alt="public/img">
                <h2 class="title">{{translate('Your')}} <span class="d-block">{{translate('All Fresh Food')}}</span>
                    <strong class="text--039D55">{{translate('in one Place')}}....</strong></h2>
            </div>
        </div>
                ...
                <form id="form-id" action="{{route('admin.auth.login')}}" method="post">
                    ...
                    <div class="auth-header">
                        <div class="mb-5">
                            ...
                            <span
                                class="badge badge-soft-info mt-2">( {{translate('admin_or_employee_signin')}} )</span>
                        </div>
                    </div>
                        ...
                        <div class="row pt-2 pb-2 align-items-center">
                            <div class="col-6 pr-0">
                                <input type="text" class="form-control form-control-lg" name="default_captcha_value"
                                       value=""
                                       placeholder="{{\App\CentralLogics\translate('Enter captcha value')}}"
                                       autocomplete="off">
                            </div>
                            <div class="col-6 input-icons bg-white rounded">
                                <div onclick="javascript:re_captcha();" class="d-flex align-items-center">
                                    <img src="{{ URL('/admin/auth/code/captcha/1') }}" class="rounded"
                ...
                @if(env('APP_MODE')=='demo')
                    <div class="auto-fill-data-copy">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div>
                                <button class="btn action-btn btn--primary m-0" onclick="copy_cred()"><i
                                        class="tio-copy"></i>
                                </button>
                            </div>
                        </div>
