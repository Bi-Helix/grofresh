        ...
        <div class="card">
            <div class="card-header border-0 py-1">
                <h5 class="card-header-title py-3 d-flex align-items-center">
                    <span>{{translate('Time Slot List')}}</span> <span
                        class="ml-1 badge-pill py-1 px-2 badge badge-soft-secondary">{{count($timeSlots)}}</span>
                </h5>
            </div>
            <!-- Table -->
                    ...
                    @foreach($timeSlots as $key=>$timeSlot)
                        <tr>
                            ...
                            <td>
                                ...
                                <form
                                    action="{{route('admin.business-settings.store.timeSlot.delete',[$timeSlot['id']])}}"
