...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.business-settings.store.timeSlot.update',[$timeSlots['id']])}}"
                      method="post">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="time" value="{{$timeSlots['start_time']}}" name="start_time"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="time" value="{{$timeSlots['end_time']}}" name="end_time"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
