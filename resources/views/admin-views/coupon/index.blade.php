...
@section('content')
                            ...
                            <div class="row gx--3">
                                ...
                                <div class="col-md-4 col-sm-6" id="limit-for-user">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="limit" value="{{old('limit')}}" id="user-limit"
                                               min="1" class="form-control" placeholder="{{ translate('EX: 10') }}"
                                               required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6" id="discount_amount_div">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('discount amount')}}</label>
                                        <input type="number" step="any" min="1" max="10000" name="discount"
                                               id="discount_amount" value="{{old('discount') ? old('discount') : 0 }}"
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('minimum')}} {{translate('purchase')}}</label>
                                        <input type="number" step="any" name="min_purchase"
                                               value="{{ old('min_purchase') ? old('min_purchase') : 0 }}" min="0"
                                ...
                                <div class="col-md-4 col-sm-6" id="max_discount_div">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('maximum')}} {{translate('discount')}}</label>
                                        <input type="number" step="any" min="0"
                                               value="{{ old('max_discount') ? old('max_discount') : 0 }}" max="1000000"
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('start')}} {{translate('date')}}</label>
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('expire')}} {{translate('date')}}</label>
                                        <label class="input-date">
                ...
                <div class="card">
                    <div class="card-header flex-between border-0">
                        <div class="card--header">
                            <h5 class="card-title">{{translate('Coupon Table')}} <span
                                    class="ml-2 badge badge-pill badge-soft-secondary">{{ $coupons->total() }}</span>
                            </h5>
                            <form action="{{url()->current()}}" method="GET">
                                <div class="input-group">
                                    <input id="datatableSearch_" type="search" name="search"
                                           class="form-control"
                                           placeholder="{{translate('Search by title or coupon code')}}"
                                           aria-label="Search"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="coupon_details">
                                            <strong
                                                class="text--title">{{ translate('Code')}} : {{$coupon['code']}}</strong>
                                        </span>
                                        <span id="coupon_details">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn--container justify-content-center">
                                            <a class="action-btn btn--warning btn-outline-warning" id="coupon_details"
                                               href="#" data-toggle="modal" onclick="get_details(this)"
                                               data-id="{{ $coupon['id'] }}" data-toggle="modal"
                                               data-target="#exampleModalCenter">
                                                <i class="tio-invisible"></i></a>
                                            <a class="action-btn"
                                               href="{{route('admin.coupon.update',[$coupon['id']])}}"><i
                                                    class="tio-edit"></i></a>
                                            <a class="action-btn btn--danger btn-outline-danger" href="javascript:"
                                               onclick="form_alert('coupon-{{$coupon['id']}}','{{translate('Want to delete this coupon ?')}}')"><i
    ...
    <div class="modal fade" id="quick-view" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
