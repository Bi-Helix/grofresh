                        ...
                        <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                            ...
                            <div class="row gx--3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('coupon')}} {{translate('type')}}</label>
                                        <select name="coupon_type" class="form-control"
                                                onchange="coupon_type_change(this.value)">
                                            <option
                                                value="default" {{$coupon['coupon_type']=='default'?'selected':''}}>{{translate('default')}}</option>
                                            <option
                                                value="first_order" {{$coupon['coupon_type']=='first_order'?'selected':''}}>{{translate('first')}} {{translate('order')}}</option>
                                            <option
                                                value="free_delivery" {{$coupon['coupon_type']=='free_delivery'?'selected':''}}>{{translate('free_delivery')}}</option>
                                            <option
                                                value="customer_wise" {{$coupon['coupon_type']=='customer_wise'?'selected':''}}>{{translate('customer_wise')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('coupon title')}}</label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('coupon code')}}</label>
                                ...
                                <div class="col-md-4 col-sm-6" id="limit-for-user"
                                     style="display: {{$coupon['coupon_type']=='first_order'?'none':'block'}}">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('limit')}} {{translate('for')}} {{translate('same')}} {{translate('user')}}</label>
                                        <input type="number" name="limit" id="user-limit" min="1"
                                               value="{{$coupon['limit']}}" class="form-control"
                                               {{ $coupon['coupon_type']!='first_order' ? 'required' : '' }}
                                               placeholder="{{ translate('EX: 10') }}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6" id="discount_type_div"
                                     style="display: {{$coupon['coupon_type']=='free_delivery'?'none':'block'}}">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('discount')}} {{translate('type')}}</label>
                                        <select name="discount_type" id="discount_type" class="form-control">
                                            <option
                                                value="amount" {{$coupon['discount_type']=='amount'?'selected':''}}>{{translate('amount')}}</option>
                                            <option
                                                value="percent" {{$coupon['discount_type']=='percent'?'selected':''}}>{{translate('percent')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6" id="discount_amount_div"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" max="10000" step="any"
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('min')}} {{translate('purchase')}}</label>
                                        <input type="number" name="min_purchase" step="any"
                                ...
                                <div
                                    class="col-md-4 col-sm-6 {{$coupon['coupon_type']=='free_delivery' || $coupon->discount_type == 'amount'?'d-none':'d-block'}}"
                                    id="max_discount_div">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('max')}} {{translate('discount')}}</label>
                                        <input type="number" min="0" max="1000000" step="any"
                                               value="{{$coupon['max_discount']??0}}" name="max_discount"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                ...
                                <div class="col-md-4 col-6" id="customer_div"
                                     style="display: {{$coupon['coupon_type']=='customer_wise'?'block':'none'}}">
                                    <div class="form-group">
                                        <label class="input-label"
                                        ...
                                        <select name="customer_id" id="customer_id"
                                            ...
                                            @foreach($customers as $customer)
                                                <option
                                                    value="{{$customer->id}}" {{ $customer->id == $coupon['customer_id'] ? 'selected' : '' }}>{{$customer->f_name.' '. $customer->l_name}}</option>
                                            @endforeach
                                        </select>
