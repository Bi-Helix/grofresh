                    ...
                    <div class="card-header flex-wrap align-items-start border-0">
                        <div class="order-invoice-left">
                            <h1 class="page-header-title">
                                ...
                                <span
                                    class="badge badge-soft-info py-2 px-3">{{$order->branch?$order->branch->name:'Branch deleted!'}}</span>
                            </h1>
                        ...
                        <div class="order-invoice-right mt-3 mt-sm-0">
                            <div class="btn--container ml-auto align-items-center justify-content-end">
                                @if($order['order_type']!='self_pickup' && $order['order_type'] != 'pos')
                                    @if($order['order_status']=='out_for_delivery')
                                        ...
                                        @else
                                            <a class="btn btn-outline-info font-semibold" href="javascript:"
                                               data-toggle="tooltip"
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                <h6 class="text-capitalize">
                                    ...
                                    :</span> <span
                                        class="text--title font-bold">{{ translate(str_replace('_',' ',$order['payment_method']))}}</span>
                                </h6>
                                @if(!in_array($order['payment_method'], ['cash_on_delivery', 'wallet_payment', 'offline_payment']))
                                    <h6 class="text-capitalize">
                                        @if($order['transaction_reference']==null && $order['order_type']!='pos')
                                            <span
                                                class="text-body mr-2"> {{translate('reference')}} {{translate('code')}}
                                        :</span>
                                        ...
                                        @elseif($order['order_type']!='pos')
                                            <span
                                                class="text-body mr-2">{{translate('reference')}} {{translate('code')}}
                                        :</span> <span
                                                class="text--title font-bold"> {{$order['transaction_reference']}}</span>
                                        @endif
                                    </h6>
                                @endif
                                ...
                                <h6>
                                    <span
                                        class="text-body mr-2">{{ translate('payment') }} {{ translate('status') }} : </span>
                                ...
                                <h6 class="text-capitalize">
                                    ...
                                    :<label
                                        class="badge badge-soft-primary ml-3">{{ translate(str_replace('_',' ',$order['order_type'])) }}</label>
                                </h6>
                                            ...
                                            <td>
                                                <div class="media media--sm">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        @endif
                                                        <h5 class="mt-1"><span
                                                                class="text-body">{{translate('Unit')}}</span>
                                                            : {{$detail['unit']}} </h5>
                                                        <h5 class="mt-1"><span
                                                                class="text-body">{{translate('Unit Price')}}</span>
                                                            : {{$detail['price']}} </h5>
                                                        <h5 class="mt-1"><span
                                                                class="text-body">{{translate('QTY')}}</span>
                                                            : {{$detail['quantity']}} </h5>
                                                    </div>
                                                </div>
                                            </td>
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right justify-content-end">
                                    ...
                                    <dt class="col-6 text-left">
                                        <div class="ml-auto max-w-130px">
                                            {{translate('TAX')}}
                                            / {{translate('VAT')}} {{ $vat_status == 'included' ? translate('(included)') : '' }}
                                            :
                                        </div>
                                    </dt>
                                    <dd class="col-6 col-xl-5 pr-5">
                                    ...
                                    <dd class="col-6 col-xl-5 pr-5">
                                        {{ Helpers::set_symbol($total+$del_c+$updated_total_tax-$order['coupon_discount_amount']-$order['extra_discount']) }}
                                        <hr>
                                    </dd>
                                    ...
                                    @else
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn--primary" type="button"
                                                    onclick="get_offline_payment_data(this)"
                                                    data-id="{{ $order['id'] }}"
                                                    data-target="#payment_verify_modal"
                                                    data-toggle="modal">{{ translate('Verify_Payment') }}</button>
                                        </div>
                                    @endif
                        ...
                        <div class="card-body">
                            @if($order['order_type'] != 'pos')
                                ...
                                <div class="hs-unfold w-100 mt-3">
                                    <span
                                        class="d-block form-label font-bold mb-2">{{translate('Payment Status')}}:</span>
                                    <div class="dropdown">
                                        <button
                                            class="form-control h--45px dropdown-toggle d-flex justify-content-between align-items-center w-100"
                                            type="button"
                                    ...
                                    <div class="d-flex flex-wrap g-2">
                                        <div class="hs-unfold w-0 flex-grow min-w-160px">
                                            <label class="input-date">
                                                <input class="js-flatpickr form-control flatpickr-custom min-h-45px"
                                                       type="text"
                                                       value="{{ date('d M Y',strtotime($order['delivery_date'])) }}"
                                                       name="deliveryDate" id="from_date" data-id="{{ $order['id'] }}"
                                        ...
                                        <div class="hs-unfold w-0 flex-grow min-w-160px">
                                            <select class="custom-select custom-select time_slote" name="timeSlot"
                                                    data-id="{{$order['id']}}">
                                                <option disabled
                                                        selected>{{translate('select')}} {{translate('Time Slot')}}</option>
                                ...
                                @if (!$order->delivery_man)
                                    <div class="mt-3">
                                        <button class="btn btn--primary w-100" type="button"
                                                data-target="#assign_delivey_man_modal"
                                                data-toggle="modal">{{ translate('assign delivery man manually') }}</button>
                                    </div>
                                @endif
                                @if ($order->delivery_man)
                                    <div class="card mt-2">
                                    ...
                                    <span class="card-header-icon">
                                        <i class="tio-user"></i>
                                                ...
                                                @if ($order->order_status != 'delivered')
                                                    <a type="button" href="#assign_delivey_man_modal"
                                                       class="text--base cursor-pointer ml-auto text-sm"
                                            ...
                                            <div
                                                class="media align-items-center deco-none customer--information-single">
                        ...
                        <div class="media align-items-center deco-none resturant--information-single">
                            <div class="avatar avatar-circle">
                                <img class="avatar-img w-75px"
                                     ...
                                     src="{{asset('storage/app/public/branch/'.$order->branch?->image)}}"
                                     alt="Image Description">
                            </div>
                            <div class="media-body">
            ...
            <div class="modal-dialog modal-lg offline-details">
                <div class="modal-content">
                    ...
                    <div class="btn--container justify-content-end my-2 mx-3">
                        <a type="reset" class="btn btn--reset"
                           onclick="verify_offline_payment(2)">{{ translate('Payment_Did_Not_Received') }}</a>
                        <a type="submit" class="btn btn--primary"
                           onclick="verify_offline_payment(1)">{{ translate('Yes,_Payment_Received') }}</a>
                    </div>
                </div>
            </div>
        </div>
