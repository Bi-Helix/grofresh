                                ...
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option
                                                value="driving_license">{{translate('driving')}} {{translate('license')}}</option>
                                            <option value="nid">{{translate('nid')}}</option>
                                            <option
                                                value="restaurant_id">{{translate('store Id')}} {{translate('id')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-0">
                                    <label class="form-label d-block">
                                        {{ translate('Deliveryman Image') }} <span
