                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6" id="max_amount_div">
                            <div class="form-group mb-0">
                                ...
                                <input type="number" step="0.1" name="maximum_amount" value="{{old('maximum_amount')}}"
                                       class="form-control" placeholder="{{ translate('maximum_amount') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-header border-0">
                <div class="card--header justify-content-between max--sm-grow">
                    <h5 class="card-title">{{translate('discount_list')}} <span
                            class="badge badge-soft-secondary">{{ $discounts->total() }}</span></h5>
