...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between mb-4">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder" data-toggle="modal"
                        ...
                        <div class="card-header">
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                @if ($data['is_published'] == 0)
                                    <button class="text-danger bg-transparent p-0 border-0 mr-2" data-toggle="modal"
                                            data-target="#deleteThemeModal_{{$key}}"><img
                                            src="{{asset('public/assets/admin/img/delete.svg')}}" class="svg" alt="">
                                    </button>
                                    <!-- Delete Theme Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="{{asset('public/assets/admin/img/delete.png')}}"
                                                             alt="">
                                                    </div>
                                                    ...
                                                    <p class="mb-5">{{ translate('once_you_delete') }}
                                                        , {{ translate('you_will_lost_the_this'.' ') }} {{ $data['name'] }}</p>
                                ...
                                <button
                                    ...
                                    data-toggle="modal" data-target="#shiftThemeModal_{{$key}}"><img
                                        src="{{asset('public/assets/admin/img/check.svg')}}" class="svg" alt="">
                                </button>
                                ...
                                <div class="modal fade" id="shiftThemeModal_{{$key}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-4 px-sm-5 text-center">
                                                <div class="mb-3 text-center">
                                                    <img width="75" src="{{asset('public/assets/admin/img/shift.png')}}"
                                                         alt="">
                                                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                <img src="{{asset('public/assets/admin/img/addon_setting.png')}}"
                                                     loading="lazy"
