    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body p-2 pt-3">
                ...
                <form class="product-form px-3 pb-3" action="{{route('admin.product.bulk-export')}}" method="GET"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="type" id="type"
                                        data-placeholder="{{translate('select')}} {{translate('type')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group date_wise">
                                <label class="input-label"
                                       for="exampleFormControlSelect1">{{translate('from')}} {{translate('date')}}<span
                                        class="input-label-secondary"></span></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group date_wise">
                                <label class="input-label text-capitalize"
                                       for="exampleFormControlSelect1">{{translate('to')}} {{translate('date')}}<span
                                        class="input-label-secondary"></span></label>
                        ...
                        <div class="col-12">
                            <div class="btn--container justify-content-end">
                                ...
                                <button class="btn btn--primary" type="submit"
                                        ...
                                        title="{{translate('bulk_export')}}">{{translate('export')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
