                        ...
                        <div class="card-body">
                            <h5 class="text-center mt-2">
                                ...
                                <a href="{{asset('public/assets/product_bulk_format.xlsx')}}" download=""
                                   class="text--primary-2">{{ translate('Download Here') }}</a>
                            </h5>
                            <div class="form-group mt-4">
                                <label class="drag--area mb-0 mx-auto cursor-pointer" ondrop="drop(event)"
                                       ondragover="allowDrop(event)">
                                    <img class="icon" src="{{asset('/public/assets/admin/img/cloud.png')}}" alt="">
                                    <div
                                        class="drag-header">{{ translate('Click here to import the .xlsx file here') }}</div>
                                    <div class="__choose-input">
                                        <input type="file" name="products_file" class="form-control" id="import-file"
                                               accept=".xlsx">
                                    </div>
