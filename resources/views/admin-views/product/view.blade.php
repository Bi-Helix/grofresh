            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-borderless table-thead-bordered product--desc-table">
                        ...
                        <tr>
                            <th class="px-4 border-0"><h4
                                    class="m-0 text-capitalize">{{translate('short_description')}}</h4></th>
                            <th class="px-4 border-0"><h4 class="m-0 text-capitalize">{{translate('price')}}</h4></th>
                            <th class="px-4 border-0"><h4 class="m-0 text-capitalize">{{translate('variations')}}</h4>
                            </th>
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach($product->tags as $tag)
                                    <span
                                        class="badge-soft-success mb-1 mr-1 d-inline-block px-2 py-1 rounded">{{$tag->tag}} </span>
                                    <br>
                                @endforeach
                            </td>
                        </tr>
                                        ...
                                        <div class="m-0 __see-more-txt-item">
                                            @if (strlen($review['comment']) > 100)
                                                ...
                                                <div class="text-right">
                                                    <span
                                                        class="see__more text-info cursor-pointer">{{translate('... See more')}}</span>
                                                </div>
                                            @else
                                                {{$review['comment']}}
                                            @endif
