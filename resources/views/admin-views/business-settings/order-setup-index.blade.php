        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="business-setting">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.store.order-setup-update')}}" method="post"
                            ...
                            <div class="row">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1"
                                                      ...
                                                      data-original-title="{{translate('If this field is active the maximum amount for Cash on Delivery order is apply')}}"><img
                                                        src="{{asset('public/assets/admin/img/info-circle.svg')}}"
                                                        alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input"
                                                   name="maximum_amount_for_cod_order_status" {{ $max_amount_status == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label
                                            class="input-label text-capitalize">{{translate('Maximum Amount for COD Order')}}
                                            <i class="tio-info-outined"
                                               data-toggle="tooltip"
                                               data-placement="top"
                                               title="{{ translate('The maximum amount for Cash on Delivery order.') }}"></i>
                                        </label>
                                        <input type="number" value="{{$maximum_amount_for_cod_order}}" step="0.1"
                                               name="maximum_amount_for_cod_order" class="form-control" placeholder=""
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" value="{{$mov}}"
                                               step="0.1" name="minimum_order_value" class="form-control" placeholder=""
                                               required>
                                    </div>
                                </div>
                            </div>
