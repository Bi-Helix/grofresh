                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            <div class="form-group mt-4">
                                <label
                                    class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between mb-2">
                                    <span
                                    ...
                                    <input class="toggle-switch-input" type="checkbox" class="status"
                                           name="play_store_status"
                                ...
                                <div class="mt-3">
                                    <label class="form-label"
                                        ...
                                        <span class="form-label-secondary ml-1" data-toggle="tooltip"
                                              ...
                                              data-original-title="{{ translate("If there is any update available in the admin panel and for that, the previous user app will not work, you can force the customer from here by providing the minimum version for force update. That means if a customer has an app below this version the customers must need to update the app first. If you don't need a force update just insert here zero (0) and ignore it.") }}"><img
                                                src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="info">
                                           </span>
                                    </label>
