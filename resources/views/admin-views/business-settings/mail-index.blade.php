                        ...
                        <div class="collapse" id="collapseExample">
                            <form class="pt-3" action="javascript:">
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-4">
                                        <button type="button" onclick="send_mail()"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <label
                                class="control-label h3 mb-0 text-capitalize mr-3">{{translate('mail configuration status')}}</label>
                            <div class="custom--switch">
                                <input type="checkbox" name="status" value="" id="switch6" switch="primary"
                                       ...
                                       id="stocksCheckbox{{ 1 }}" {{ $data['status'] ==  1 ? 'checked' : '' }}>
                                <label for="switch6" data-on-label="on" data-off-label="off"></label>
                            </div>
                        </div>
                        <form
                            action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.mail-config'):'javascript:'}}"
                            method="post"
                            ...
                            @if(isset($config))
                                <div class="row mt-3">
                                    <div class="form-group col-md-6">
                                        <label
                                            class="form-label">{{translate('mailer')}} {{translate('name')}}</label><br>
                                        <input type="text" placeholder="{{ translate('ex : Alex') }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" placeholder="{{ translate('ex : tls') }}"
                                ...
                                <div class="btn--container justify-content-end">
                                    ...
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            ...
                                            class="btn btn-primary mt-2 mb-2">{{translate('save')}}</button>
                                </div>
                            @else
                                <button type="submit"
                                        class="btn btn-primary mt-2 mb-2">{{translate('configure')}}</button>
                            @endif
                        </form>
                    </div>
                </div>
