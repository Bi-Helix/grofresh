        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="business-setting">
                <div class="card mb-3">
                    <div class="card-body">
                        <div
                            class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border border-primary-70 rounded align-items-center p-2">
                            @php($config = \App\CentralLogics\Helpers::get_business_settings('maintenance_mode'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="time_zone" id="time_zone" data-maximum-selection-length="3"
                                            ...
                                            <option value='US/Central'>(UTC-06:00) Central Time (US &amp; Canada)
                                            </option>
                                            ...
                                            <option value='US/Eastern'>(UTC-05:00) Eastern Time (US &amp; Canada)
                                            </option>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="time_format" class="form-control">
                                            <option
                                                value="12" {{$time_format=='12'?'selected':''}}>{{translate('12_hour')}}</option>
                                            <option
                                                value="24" {{$time_format=='24'?'selected':''}}>{{translate('24_hour')}}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <input type="checkbox" name="self_pickup"
                                                   class="toggle-switch-input" {{ $sp == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <span class="line--limit-1">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1"
                                                      data-toggle="tooltip" data-placement="right"
                                                      data-original-title="{{translate('If this field is active, customer have to verify their email verication through an OTP')}}"><img
                                                        src="{{asset('public/assets/admin/img/info-circle.svg')}}"
                                                        alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input"
                                                   name="email_verification" {{ $ev == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1"
                                                      data-toggle="tooltip" data-placement="right"
                                                      data-original-title="{{translate('If this field is active, customer have to verify their phone number through an OTP')}}"><img
                                                        src="{{asset('public/assets/admin/img/info-circle.svg')}}"
                                                        alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input"
                                                   name="phone_verification" {{ $pv == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <input type="checkbox" name="dm_self_registration"
                                                   class="toggle-switch-input" {{ $dm_self_registration == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control"
                                            onclick="guest_checkout_status('{{route('admin.business-settings.store.guest-checkout',[$guest_checkout_status])}}')">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                            ...
                                            <input type="checkbox" name="guest_checkout"
                                                   class="toggle-switch-input" {{ $guest_checkout == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <input type="checkbox" name="partial_payment"
                                                   class="toggle-switch-input" {{ $partial_payment == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="partial_payment_combine_with" class="form-control">
                                            <option
                                                value="COD" {{$combine_with=='COD'?'selected':''}}>{{translate('COD')}}</option>
                                            <option
                                                value="digital" {{$combine_with=='digital'?'selected':''}}>{{translate('digital')}}</option>
                                            <option
                                                value="offline" {{$combine_with=='offline'?'selected':''}}>{{translate('offline')}}</option>
                                            <option
                                                value="all" {{$combine_with=='all'?'selected':''}}>{{translate('all')}}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <center>
                                            <img id="viewer_2"
                                                 ...
                                                 onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                                 src="{{asset('storage/app/public/restaurant/'.$fav_icon)}}"
                                                 alt="logo image"/>
                                        </center>
                                    </div>
                                </div>
...
@push('script_2')
    ...
    <script>
        ...
        function guest_checkout_status(route) {
