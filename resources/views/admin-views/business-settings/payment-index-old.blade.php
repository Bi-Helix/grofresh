            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{route('admin.business-settings.web-app.payment-method-update',['cash_on_delivery'])}}"
                            method="post">
                            @csrf
                            @if(isset($config))
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{route('admin.business-settings.web-app.payment-method-update',['digital_payment'])}}"
                            method="post">
                            @csrf
                            @if(isset($config))
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{route('admin.business-settings.web-app.payment-method-update',['offline_payment'])}}"
                            method="post">
                            @csrf
                            @if(isset($config))
                            ...
                            @if(isset($config))
                                <h5 class="d-flex flex-wrap justify-content-between">
                                    ...
                                    <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                        <span
                                            class="mr-2 switch--custom-label-text text-primary on text-uppercase">on</span>
                                        <span class="mr-2 switch--custom-label-text off text-uppercase">off</span>
                                        <input type="checkbox" name="status" value="1"
                                               class="toggle-switch-input" {{$config?($config['status']==1?'checked':''):''}}>
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="paypal_client_id"
                                           ...
                                           placeholder="{{translate('paypal')}} {{translate('client')}} {{translate('id')}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="paypal_secret"
                                           value="{{env('APP_MODE')!='demo'?$config['paypal_secret']:''}}"
                                           placeholder="{{translate('paypalsecret')}}">
                                </div>
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="published_key"
                                           ...
                                           placeholder="{{translate('published')}} {{translate('key')}}">
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="api_key"
                                           value="{{env('APP_MODE')!='demo'?$config['api_key']:''}}"
                                           placeholder="{{translate('api')}} {{translate('key')}}">
                                </div>
                                <div class="text-right">
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="secret_key"
                                           ...
                                           placeholder="{{translate('secret')}} {{translate('key')}}">
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="merchant_id"
                                           value="{{env('APP_MODE')!='demo'?$config['merchant_id']:''}}"
                                           placeholder="{{translate('merchant')}} {{translate('id')}}">
                                </div>
                                <div class="text-right">
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                            class="btn btn-primary px-5">{{translate('save')}}
                                    </button>
                                </div>
                            @else
                                <div class="text-right">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="api_key"
                                           value="{{env('APP_MODE')!='demo'?$config['api_key']??'':''}}"
                                           placeholder="{{translate('bkash')}} {{translate('api')}} {{translate('key')}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="api_secret"
                                           value="{{env('APP_MODE')!='demo'?$config['api_secret']??'':''}}"
                                           placeholder="{{translate('bkash')}} {{translate('api')}} {{translate('secret')}}">
                                </div>
                                <div class="form-group">
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="public_key"
                                           ...
                                           placeholder="{{translate('public_key')}}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="secret_key"
                                           value="{{env('APP_MODE')!='demo'?$config['secret_key']??'':''}}"
                    ...
                    <div class="card-body">
                        ...
                        <form
                            ...
                            @if(isset($config))
                                ...
                                <div class="payment--gateway-img">
                                    <img src="{{asset('/public/assets/admin/img/MercadoPago_(Horizontal).svg')}}"
                                         alt="public">
                                </div>
