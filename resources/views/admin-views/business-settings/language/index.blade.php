    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.web-app.system-setup.language.add-new')}}"
                              method="post"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="recipient-name"
                                               class="col-form-label">{{translate('Language Name')}}</label>
                                        <input type="text" class="form-control" id="recipient-name" name="name"
                                               placeholder="{{translate('Ex : English')}}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                                ...
                                                <div class="btn--container justify-content-end">
                                                    ...
                                                    @if($data['code']!='en')
                                                        <a class="action-btn btn--primary btn-outline-primary"
                                                           ...
                                                           href="javascript:void(0)"><i class="tio-edit"></i></a>
                                                        @if($data['default'] != true)
                                                            <button class="action-btn btn--danger btn-outline-danger"
                                                                ...
                                                                <i class="tio-delete-outlined"></i></button>
                                                        @endif
                                                    @endif
                                                </div>
                                            </td>
                ...
                <div class="modal fade" id="lang-modal-update-{{$data['code']}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.business-settings.web-app.system-setup.language.update')}}"
                                  method="post">
                                @csrf
