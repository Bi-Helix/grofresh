    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="delivery-fee">
                <div class="row g-3">
                    <div class="col-sm-12">
                        <form action="{{route('admin.branch.update',[$main_branch['id']])}}" method="post"
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <div class="form-group mb-0">
                                                                <label
                                                                    class="input-label">{{translate('branch_name')}}</label>
                                                                <input type="text" name="name" class="form-control"
                                                                       placeholder="{{ translate('Ex: xyz branch') }}"
                                                                       value="{{ $main_branch->name }}" maxlength="255"
                                                                       required>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="d-flex flex-column justify-content-center h-100">
                                                        <div class="text-center mb-3 text--title">
                                                            ...
                                                            <small class="text-danger">* ( {{translate('ratio')}} 1:1
                                                                )</small>
                                                        </div>
                                                        <label class="upload--squire">
                                                            <input type="file" name="image" id="customFileEg1" class=""
                                                                   value="{{$main_branch['image']}}"
                                                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*"
                                                                   hidden>
                                                            <img id="viewer"
                                                                 src="{{asset('storage/app/public/branch')}}/{{$main_branch['image']}}"
                                                ...
                                                <div class="col-lg-12 mt-4">
                                                    <div class="row g-3">
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="form-group mb-0">
                                                                <label
                                                                    class="input-label">{{translate('phone')}}</label>
                                                                <input type="phone" name="phone" class="form-control"
                                                                       value="{{ $main_branch->phone }}"
                                                                       maxlength="255"
                                                                       placeholder="{{ translate('EX : +09853834') }}"
                                                                       required>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="form-group mb-0">
                                                                <label
                                                                    class="input-label">{{translate('email')}}</label>
                                                                <input type="email" name="email" class="form-control"
                                                                       value="{{ $main_branch->email }}"
                                                                       maxlength="255"
                                                        ...
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="form-group mb-0">
                                                                <label
                                                                    class="input-label">{{translate('password')}}</label>
                                                                <div class="position-relative">
                                                                    <input type="password" name="password"
                                                                           class="form-control"
                                                                           placeholder="{{ translate('Ex: 5+ Character') }}"
                                                                           maxlength="255"
                                                                           value="{{ old('password') }}">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" name="latitude" id="latitude"
                                                                       ...
                                                                       maxlength="255"
                                                                       value="{{ $main_branch->latitude }}" step="any"
                                                                       required readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" name="longitude" id="longitude"
                                                                       ...
                                                                       maxlength="255"
                                                                       value="{{ $main_branch->longitude }}" step="any"
                                                                       required readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="number" name="coverage" min="1" max="1000"
                                                                       ...
                                                                       value="{{ $main_branch->coverage }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@push('script_2')
    ...
    <!-- Static Maps -->
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ \App\Model\BusinessSetting::where('key', 'map_api_client_key')->first()?->value }}&libraries=places&v=3.45.8"></script>
    <script>
