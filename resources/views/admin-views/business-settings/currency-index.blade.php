            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.business-settings.currency-add')}}" method="post"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" placeholder="{{ translate('ex : Bangladesh') }}" class="form-control"
                               name="country">
                    </div>

                    <div class="form-group mb-2">
                        <label style="padding-left: 10px">{{ translate('Code') }}</label><br>
                        <input type="text" placeholder="{{ translate('ex : USD') }}" class="form-control"
                               name="currency_code">
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" placeholder="{{ translate('ex : 1') }}" class="form-control"
                               name="exchange_rate">
                    </div>
