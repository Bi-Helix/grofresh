...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{route('admin.business-settings.web-app.third-party.offline-payment.update', [$method['id']])}}"
              method="post">
            @csrf

            <div class="d-flex justify-content-end my-3">
                <div class="d-flex gap-2 justify-content-end align-items-center text-primary font-weight-bold"
                     id="bkashInfoModalButton">
                    {{ translate('Section View') }}<i class="tio-info ml-1" data-toggle="tooltip"
                                                      title="{{translate('Admin needs to add the payment information for any offline payment, which customers will use to pay.')}}"></i>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <div>
                        <button type="button" class="btn btn--primary" id="add-payment-method-field"><i
                                class="tio-add"></i>{{translate('Add New Field')}}</button>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-end gap-3 mb-4">
                        <div class="flex-grow-1">
                            ...
                            <input type="text" maxlength="255" name="method_name" id="method_name" class="form-control"
                                   value="{{ $method['method_name'] }}" placeholder="{{ translate('ABC Company') }}"
                                   required>
                        </div>
                    </div>
                            ...
                            <div class="flex-grow-1">
                                <div>
                                    ...
                                    <input type="text" name="field_name[]" class="form-control" maxlength="255"
                                           value="{{ $field['field_name'] }}" placeholder="{{ translate('Bank Name') }}"
                                           required>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div>
                                    ...
                                    <input type="text" name="field_data[]" class="form-control" maxlength="255"
                                           value="{{ $field['field_data'] }}" placeholder="{{ translate('ABC Bank') }}"
                                           required>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            ...
                                            <input type="text" name="field_data[]" class="form-control" maxlength="255"
                                                   ...
                                                   placeholder="{{ translate('ABC Bank') }}" required>
                                        </div>
                                    </div>
                                    <div class="" data-toggle="tooltip" data-placement="top"
                                         title="{{translate('Remove the input field')}}">
                                        <div class="action-btn btn--danger btn-outline-danger delete"
                                             onclick="delete_input_field({{$key}})">
            ...
            <div class="d-flex justify-content-end mb-3 mt-4">
                <div class="d-flex gap-2 justify-content-end text-primary align-items-center font-weight-bold"
                     id="paymentInfoModalButton">
                    {{ translate('Section View') }} <i class="tio-info ml-1" data-toggle="tooltip"
                                                       title="{{translate('Admin needs to set the required customer information, which needs to be provided to the customers before placing a booking through offline payment')}}"></i>
                </div>
            </div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <div>
                        <button type="button" class="btn btn--primary" id="add-payment-information-field"><i
                                class="tio-add"></i>{{translate('Add New Field')}}</button>
                    </div>
                </div>
                ...
                <div class="card card-body mb-3">
                    <div class="d-flex align-items-end gap-3 mb-4">
                        <div class="flex-grow-1">
                            ...
                            <textarea name="payment_note" class="form-control"
                                      placeholder="{{ translate('Payment Note') }}" data-toggle="tooltip"
                                      title="Field is not editable"
                                      id="payment_note" style="background-color: #e9ecef;"
                                      readonly>{{ $method['payment_note'] }}</textarea>
                        </div>
                    </div>

                    @if($method['method_informations'][0])
                        @php($information = $method['method_informations'][0])
                        <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer">
                            <div class="flex-grow-1">
                                <div class="">
                                    ...
                                    <input type="text" name="information_name[]" class="form-control" maxlength="255"
                                           value="{{ $information['information_name'] }}" placeholder=""
                                           id="information_name_${count_info}" required>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div class="">
                                    <label class="input-label">{{translate('Input Field Placeholder/Hints')}} </label>
                                    <input type="text" name="information_placeholder[]" class="form-control"
                                           maxlength="255"
                                           value="{{ $information['information_placeholder'] }}" placeholder=""
                                           required>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-10 mb-2">
                                    <input class="custom-control mr-1" type="checkbox"
                                           name="information_required[]" {{$information['information_required'] ? 'checked' : ''}}>
                    ...
                    <div id="information-field">
                        @foreach($method['method_informations'] as $key=>$information)
                            @if($key>0)
                                <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer"
                                     id="information-row--{{ $key }}">
                                    <div class="flex-grow-1">
                                        <div class="">
                                            <label class="input-label">{{translate('Input Field Name')}} </label>
                                            <input type="text" name="information_name[]" class="form-control"
                                                   maxlength="255"
                                                   value="{{ $information['information_name'] }}" placeholder=""
                                                   id="information_name_${count_info}" required>
                                        </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="">
                                            <label
                                                class="input-label">{{translate('Input Field Placeholder/Hints')}} </label>
                                            <input type="text" name="information_placeholder[]" class="form-control"
                                                   maxlength="255"
                                                   value="{{ $information['information_placeholder'] }}" placeholder=""
                                                   required>
                                    ...
                                    <div class="" data-toggle="tooltip" data-placement="top"
                                         title="{{translate('Remove the input field')}}">
                                        <div class="action-btn btn--danger btn btn-outline-danger delete"
                                             onclick="delete_information_input_field({{ $key }})">
                                            <i class="tio-delete-outlined"></i>
                                        </div>
                                    </div>
                                </div>
...
@push('script_2')
    ...
    <script>
        ...
        function delete_input_field(input_row_id) {
            console.log(input_row_id);
            $(`#field-row--${input_row_id}`).remove();
            count--;
        }
        ...
        jQuery(document).ready(function ($) {
            count = '{{ count($method['method_fields']) }}';
                    ...
                    $('#method-field').append(
                        `<div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-payment" id="field-row--${count}">
                            ...
                            <div class="" data-toggle="tooltip" data-placement="top" title="{{translate('Remove the input field')}}">
                                <div class="action-btn btn--danger btn btn-outline-danger delete" onclick="delete_input_field(${count})">
                                    <i class="tio-delete-outlined"></i>
                                </div>
                            </div>
                        </div>`
            ...
            count_info = '{{ count($method['method_informations']) }}';
                ...
                if (count_info <= 15) {
                    ...
                    $('#information-field').append(
                        `<div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer" id="information-row--${count_info}">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-10 mb-2">
                                    <input class="custom-control mr-1" type="checkbox" name="information_required[]">
                                    <label class="input-label mb-0">{{translate('Is Required')}}? </label>
                                </div>
                            </div>
                            <div class="" data-toggle="tooltip" data-placement="top" title="{{translate('Remove the input field')}}">
                                <div class="action-btn btn--danger btn btn-outline-danger delete" onclick="delete_information_input_field(${count_info})">
                                    <i class="tio-delete-outlined"></i>
                                </div>
                            </div>
                        </div>`
