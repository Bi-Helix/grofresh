                        ...
                        <div class="flex-grow-1">
                            <div class="">
                                ...
                                <input type="text" name="field_data[]" class="form-control" maxlength="255"
                                       placeholder="{{ translate('ABC_Bank') }}" required>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-end gap-3 mb-4">
                        <div class="flex-grow-1">
                            ...
                            <textarea name="payment_note" class="form-control payment-note" data-toggle="tooltip"
                                      title="Field is not editable"
                                      placeholder="{{ translate('payment_Note') }}" style="background-color: #e9ecef;"
                                      readonly></textarea>
                        </div>
                    </div>

                    <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer"
                         id="information-row--${count_info}">
                        <div class="flex-grow-1">
                            <div class="">
                                ...
                                <input type="text" name="information_name[]" class="form-control" maxlength="255"
                                       placeholder="" id="information_name_${count_info}" required>
                            </div>
                        </div>
                        <div class="flex-grow-1">
                            <div class="">
