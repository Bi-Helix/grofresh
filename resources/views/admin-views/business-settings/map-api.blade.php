...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form
                    action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.third-party.map-api-store'):'javascript:'}}"
                    method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="map_api_server_key"
                                      class="form-control">{{env('APP_MODE')!='demo'?$key:''}}</textarea>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="map_api_client_key"
                                      class="form-control">{{env('APP_MODE')!='demo'?$key:''}}</textarea>
                        </div>
                    </div>
