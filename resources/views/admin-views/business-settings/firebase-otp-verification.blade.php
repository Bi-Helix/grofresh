        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{route('admin.business-settings.web-app.third-party.firebase-otp-verification-update')}}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label
                                            ...
                                            <input type="checkbox" class="toggle-switch-input"
                                                   name="status" {{ isset($firebase_otp) && $firebase_otp['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text"
                                               value="{{$firebase_otp && env('APP_MODE')!='demo' ? $firebase_otp['web_api_key'] : ''}}"
                                               name="web_api_key" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </div>
