                ...
                <div class="d-flex flex-wrap justify-content-between w-100 row-gap-1">
                    <ul class="nav nav-tabs nav--tabs border-0 ml-3">
                        <li class="nav-item mr-2 mr-md-4">
                            <a href="{{ route('admin.business-settings.web-app.third-party.fcm-index') }}"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.business-settings.web-app.third-party.fcm-config') }}"
                               class="nav-link pb-2 px-0 pb-sm-3" data-slide="2">
                    ...
                    <div class="py-1">
                        <div class="tab--content">
                            <div class="item show text-primary d-flex flex-wrap align-items-center" type="button"
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="push-notify">
                        ...
                        <form action="{{route('admin.business-settings.web-app.third-party.update-fcm-messages')}}"
                              method="post"
                                        ...
                                        <ul class="nav nav-tabs border-0">
                                            <li class="nav-item">
                                                <a class="nav-link lang_link active" href="#"
                                                   id="default-link">{{ translate('Default') }}(EN)</a>
                                            </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <span
                                                class="d-block">{{translate('order')}} {{translate('pending')}} {{translate('message')}}</span>
                                          </span>
                                            </label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content">
                                                <span
                                                    class="d-block"> {{translate('order')}} {{translate('confirmation')}} {{translate('message')}}</span>
                                              </span>
                                            </label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('order')}} {{translate('processing')}} {{translate('message')}}</span>
                                              </span>
                                            </label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('order')}} {{translate('out_for_delivery')}} {{translate('message')}}</span>
                                              </span>
                                            </label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="toggle-switch d-flex align-items-center mb-3"
                                                ...
                                                <span class="toggle-switch-content">
                                                <span
                                                    class="d-block">{{translate('order')}} {{translate('delivered')}} {{translate('message')}}</span>
                                              </span>
                                            </label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="dm_order_processing_message"
                                                      class="form-control">{{$data['message']??''}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="add_fund_message"
                                                      class="form-control">{{$data['message']??''}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="add_fund_bonus_message"
                                                      class="form-control">{{$data['message']??''}}</textarea>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="d-flex align-items-center gap-3 mb-3">
                                                            <span
                                                                class="text-dark">{{translate($item['field_name'].' message')}}</span>
                                                        </div>
                                                        <textarea name="{{$item['field_name']}}_message[]"
                                                                  class="form-control"
                                                                  placeholder="{{translate('Ex : Your order have been place')}}">{!! !empty($temporary) ? $temporary[$lang_code]['message'] : '' !!}</textarea>
                                                    </div>
                                                </div>
                                            @endforeach
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="single-item-slider owl-carousel">
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset('/public/assets/admin/img/firebase/slide-1.png')}}" alt=""
                                             class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset('/public/assets/admin/img/firebase/slide-2.png')}}" alt=""
                                             class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset('/public/assets/admin/img/firebase/slide-3.png')}}" alt=""
                                             class="mb-3">
                            ...
                            <div class="item">
                                <div class="mb-20">
                                    <div class="text-center">
                                        <img src="{{asset('/public/assets/admin/img/email-templates/3.png')}}" alt=""
                                             class="mb-3">
                                    ...
                                    <div class="btn-wrap">
                                        <button type="submit" class="btn btn--primary w-100" data-dismiss="modal"
                                                data-toggle="modal"
                                                data-target="#firebase-modal-2">{{translate('Got It')}}</button>
                                    </div>
                                </div>
                            </div>
