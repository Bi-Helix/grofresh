    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="business-setting">
                <form action="{{ route('admin.business-settings.store.customer-setup-update') }}" method="post"
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" class="toggle-switch-input"
                                                   onclick="section_visibility('customer_wallet')"
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" class="toggle-switch-input"
                                                   ...
                                                   id="customer_loyalty_point" data-section="loyalty-point-section"
                                                   value="1"
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group m-0">
                                        <label
                                            class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-4 form-control"
                                            for="add_fund_to_wallet">
                                            <span class="pr-2">{{ translate('Add Fund to Wallet') }}</span>
                                            <input type="checkbox" class="toggle-switch-input" name="add_fund_to_wallet"
                                                   id="add_fund_to_wallet" value="1"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group m-0">
                                        ...
                                        <input type="number" class="form-control"
                                               name="loyalty_point_percent_on_item_purchase" step=".01"
