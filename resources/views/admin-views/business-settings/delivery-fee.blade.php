                        ...
                        <form action="{{route('admin.business-settings.store.delivery-setup-update')}}" method="post"
                            ...
                            <div class="row">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex ml-1"
                                                      ...
                                                      data-original-title="{{translate('If this field is active and the order amount exceeds this free delivery over amount then the delivery fee will be free.')}}"><img
                                                        src="{{asset('public/assets/admin/img/info-circle.svg')}}"
                                                        alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input"
                                                   name="free_delivery_status" {{ $free_delivery_status == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-12 mt-4">
                                    ...
                                    <label class=""
                                           for="exampleFormControlInput1">{{translate('default_delivery_charge')}}
                                        <span>({{ \App\CentralLogics\Helpers::currency_symbol() }})</span></label>
                                ...
                                <div class="col-md-6 col-sm-6 mt-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="{{$free_delivery_over_amount}}"
                                               name="free_delivery_over_amount" class="form-control" placeholder=""
