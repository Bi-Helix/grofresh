...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{env('APP_MODE')!='demo'?route('admin.business-settings.web-app.system-setup.firebase_message_config'):'javascript:'}}"
                    method="post"
                    ...
                    @if(isset($data))
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control" name="apiKey"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="authDomain"
                                   value="{{env('APP_MODE')!='demo'?$data['authDomain']:''}}" required
                                   autocomplete="off"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="projectId"
                                   value="{{env('APP_MODE')!='demo'?$data['projectId']:''}}" required autocomplete="off"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="storageBucket"
                                   value="{{env('APP_MODE')!='demo'?$data['storageBucket']:''}}" required
                                   autocomplete="off" placeholder="{{translate('Ex : grofresh-3986f.appspot.com')}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="{{translate('Ex : 250728969979')}}" class="form-control"
                                   ...
                                   value="{{env('APP_MODE')!='demo'?$data['messagingSenderId']:''}}" required
                                   autocomplete="off">
                        </div>
