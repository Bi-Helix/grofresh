                                ...
                                <div class="form-group" id="db_password_div">
                                    ...
                                    <div class="input-icons">
                                        <input type="password"
                                               ...
                                               class="form-control input-field" id="db_password" style="display: inline"
                                               disabled>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           value="{{ env('APP_MODE') != 'demo' ? env('BUYER_USERNAME') : '---' }}"
                                           class="form-control"
                                           disabled>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group" id="purchase_code_div">
                                    ...
                                    <div class="input-icons">
                                        <input type="password"
                                               value="{{ env('APP_MODE') != 'demo' ? env('PURCHASE_CODE') : '---' }}"
                                               class="form-control input-field" id="purchase_code"
