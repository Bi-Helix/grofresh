        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="card--header">
                    <h5 class="card-title">{{translate('Attribute Table')}} <span
                            class="badge badge-soft-secondary">{{ $attributes->total() }}</span></h5>
                    ...
                    <button class="btn btn--primary ml-lg-4" data-toggle="modal" data-target="#attribute-modal"><i
                            class="tio-add"></i> {{translate('add_attribute')}}</button>
                </div>
            </div>
            <!-- Table -->
