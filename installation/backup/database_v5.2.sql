...
INSERT INTO `branches` (`id`, `restaurant_id`, `name`, `email`, `password`, `latitude`, `longitude`, `address`,
                        `status`, `created_at`, `updated_at`, `coverage`, `remember_token`, `image`)
VALUES (1, NULL, 'Dinajpur', 'newb@gmail.com', '$2y$10$HJW/gFTjbpX8VIDp4I.EjO0QhlFTek7ydjRMkIiDjSuCHEpWZDafK',
