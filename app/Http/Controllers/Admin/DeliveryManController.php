...
class DeliveryManController extends Controller
{
    ...
    public function store(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        try {
            ...
            if (isset($emailServices['status']) && $emailServices['status'] == 1) {
                Mail::to($dm->email)->send(new \App\Mail\Deliveryman\DMRegistration($dm, $request->password));
            }
        } catch (\Exception $e) {
        }
    ...
    public function status(Request $request): RedirectResponse
    {
        ...
        try {
            $emailServices = Helpers::get_business_settings('mail_config');
            if (isset($emailServices['status']) && $emailServices['status'] == 1) {
                Mail::to($delivery_man->email)->send(new \App\Mail\Deliveryman\DMStatusChange($delivery_man));
            }
        } catch (\Exception $e) {
        }
    ...
    public function delete(Request $request): RedirectResponse
    {
        ...
        try {
            $emailServices = Helpers::get_business_settings('mail_config');
            if (isset($emailServices['status']) && $emailServices['status'] == 1) {
                Mail::to($delivery_man->email)->send(new \App\Mail\Deliveryman\DMDelete($delivery_man));
            }
        } catch (\Exception $e) {
        }
    ...
    public function update_application(Request $request): RedirectResponse
    {
        ...
        try {
            $emailServices = Helpers::get_business_settings('mail_config');
            if (isset($emailServices['status']) && $emailServices['status'] == 1) {
                Mail::to($delivery_man->email)->send(new \App\Mail\Deliveryman\DMApprovedDenied($delivery_man));
            }
        } catch (\Exception $e) {
        }
