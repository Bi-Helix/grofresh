...
class AnalyticController extends Controller
{
    ...
    public function export_keyword_search(Request $request): StreamedResponse|string
    {
    ...
    public function export_customer_search(Request $request): StreamedResponse|string
    {
